...
/** Maps 1:1 to the "Ma Maison Reviews" SharePoint List columns. */
export interface Review {
  id: string; // SharePoint item ID (string form)
...
/** Maps 1:1 to the "Review Action Tracker" SharePoint List columns. */
